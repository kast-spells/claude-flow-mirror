...
[📋 Documentation Index](./README.md) | [⬅️ Previous: Architecture Overview](./01-architecture-overview.md) | [➡️ Next: Workflows and Dataflows](./03-workflows-and-dataflows.md)
...
**Prerequisites:**
- [Architecture Overview](./01-architecture-overview.md) - System architecture and design patterns

**Related Topics:**
- [Workflows and Dataflows](./03-workflows-and-dataflows.md) - How components interact and exchange data
- [API Reference](./04-api-reference.md) - API surface for each component
- [Data Models and Integration](./05-data-models-and-integration.md) - Component data structures

**Next Steps:**
- [Workflows and Dataflows](./03-workflows-and-dataflows.md) - Understand component interactions
- [Design Patterns Glossary](./07-design-patterns-glossary.md) - Patterns used in components
- [Performance Analysis](./11-performance-analysis.md) - Component performance characteristics

**See Also:**
- [Code Navigation Guide](./06-code-navigation-guide.md) - Find component implementations
- [Algorithm Deep Dive](./08-algorithm-deep-dive.md) - Key algorithms used
...
- [⬅️ Previous: Architecture Overview](./01-architecture-overview.md)
- [➡️ Next: Workflows and Dataflows](./03-workflows-and-dataflows.md)

**Document Map:**
```mermaid
graph LR
    A[Architecture] --> B[Component Deep Dive]
    B --> C[Workflows]
    B --> D[API Reference]
    B --> E[Data Models]
```
