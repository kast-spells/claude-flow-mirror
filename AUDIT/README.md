...
- Design Patterns → [07-design-patterns-glossary.md](./07-design-patterns-glossary.md)
- State Machines → [13-state-machines-reference.md](./13-state-machines-reference.md)

**Implementation Details:**
- Component Deep Dive → [02-component-deep-dive.md](./02-component-deep-dive.md)
- Algorithm Details → [08-algorithm-deep-dive.md](./08-algorithm-deep-dive.md)
- Concurrency → [09-concurrency-deep-dive.md](./09-concurrency-deep-dive.md)

**APIs & Integration:**
- API Reference → [04-api-reference.md](./04-api-reference.md)
- Data Models → [05-data-models-and-integration.md](./05-data-models-and-integration.md)

**Operations & Debugging:**
- Workflows → [03-workflows-and-dataflows.md](./03-workflows-and-dataflows.md)
- Error Handling → [10-error-handling-guide.md](./10-error-handling-guide.md)
- Troubleshooting → [12-troubleshooting-cookbook.md](./12-troubleshooting-cookbook.md)
- Performance → [11-performance-analysis.md](./11-performance-analysis.md)

**Reference & Navigation:**
- Code Navigation → [06-code-navigation-guide.md](./06-code-navigation-guide.md)
- Environment Variables → [14-environment-variables-reference.md](./14-environment-variables-reference.md)
- Test Infrastructure → [15-test-infrastructure.md](./15-test-infrastructure.md)
- Runtime Directories → [16-runtime-directories.md](./16-runtime-directories.md)

**Advanced Modules:**
- Consciousness Symphony → [modules/consciousness-symphony.md](./modules/consciousness-symphony.md)
- Maestro Multi-Swarm → [modules/maestro-multi-swarm.md](./modules/maestro-multi-swarm.md)
- MLE-Star Ensemble → [modules/mle-star-ensemble-agents.md](./modules/mle-star-ensemble-agents.md)

**Audit Reports:**
- Audit Overview → [audit/README.md](./audit/README.md)
- Executive Summary → [audit/00-AUDIT-EXECUTIVE-SUMMARY.md](./audit/00-AUDIT-EXECUTIVE-SUMMARY.md)
- Final Validation → [audit/FINAL-A++-VALIDATION-REPORT.md](./audit/FINAL-A++-VALIDATION-REPORT.md)

### Search Index

Use your browser's find function (Ctrl+F / Cmd+F) with these keywords:

**Components:** MCP, orchestrator, swarm, hooks, memory, neural, CLI, agents
**Patterns:** observer, factory, singleton, strategy, decorator, pub-sub
**Operations:** init, spawn, execute, coordinate, persist, cache, monitor
**Debugging:** error, exception, timeout, retry, fallback, circuit-breaker
**Performance:** benchmark, optimize, parallel, cache, pool, queue
**Configuration:** config, env, credentials, topology, strategy
**Testing:** unit, integration, e2e, mock, fixture, coverage
